...
const ScrollAnimatedText = () => {
  ...
  return (
    <section ref={sectionRef} className="py-40 mt-20 overflow-hidden relative">
      <div className="container mx-auto flex flex-col gap-8">
        <div className="transform w-[200vw] bg-[#95C11F] py-4 translate-x-[-20%] z-10">
          <h2
            ref={textRef1}
            className="text-3xl md:text-4xl lg:text-5xl text-white font-bold whitespace-nowrap text-center w-full relative left-[40%] uppercase"
            style={{
              transform: "translateX(-70%)",
            }}
          >
            Have an{" "}
            <span className="font-serif italic font-black text-[#222]">
              Idea?
            </span>
          </h2>
        </div>
        ...
        <div className="transform w-[200vw] bg-[#95C11F] py-4 -translate-x-[4%]">
          <h2
            ref={textRef2}
            className="text-3xl md:text-4xl lg:text-5xl text-white font-bold whitespace-nowrap text-center relative left-[60%] uppercase"
            style={{
